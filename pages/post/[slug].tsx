    ...
    <div>
      ...
      {submitted ? (
        <div className="my-10 mx-auto flex max-w-2xl flex-col bg-yellow-500 py-10 px-5 text-white">
          ...
          <p>Once it is approved, it will be appeared below</p>
        </div>
      ) : (
        <form
        ...
        >
          ...
          <input
            type="submit"
            className="focus:shadow-outline focus:outline:none cursor-pointer rounded bg-yellow-500 py-2 px-4 font-bold text-white shadow hover:bg-yellow-400"
          />
        </form>
      )}
